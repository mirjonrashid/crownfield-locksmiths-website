...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://crownfieldlocksmiths.co.uk/locksmiths",
  },
};
      ...
      <main className="min-h-screen bg-white pt-28 pb-20">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-500 text-lg mb-10 max-w-xl">
            We cover all 32 London boroughs. Select your borough for local
            service details and to call us directly.
          </p>
